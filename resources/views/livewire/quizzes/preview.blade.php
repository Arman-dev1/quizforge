            ...
            @if ($completed)
                <div class="qf-card m-auto w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-10 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    ...
                    @if ($outcome['category'] ?? null)
                        <p class="mt-2 inline-flex items-center gap-1.5 rounded-full bg-zinc-100 px-2.5 py-1 text-xs font-semibold text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300">
                    ...
                    @if ($outcome['show_score'] ?? false)
                        <div class="mt-6 rounded-xl bg-zinc-50 p-5 dark:bg-zinc-800/60">
                            <p class="qf-num text-4xl font-bold text-zinc-900 dark:text-white">
                            ...
                            <div class="mt-3 flex flex-wrap items-center justify-center gap-2">
                                @if (($outcome['passed'] ?? null) !== null)
                                    <span @class([
                                        ...
                                        'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/60 dark:text-emerald-300' => $outcome['passed'],
                    ...
                    @if ($outcome['redirect'] ?? null)
                        <p class="mt-6 rounded-lg bg-zinc-100 px-3 py-2 text-xs text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
