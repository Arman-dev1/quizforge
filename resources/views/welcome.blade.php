    ...
    <body class="min-h-screen bg-white antialiased dark:bg-zinc-950">
        ...
        <main>
            ...
            <section class="relative mx-auto w-full max-w-6xl overflow-hidden px-6 pb-20 pt-16 text-center sm:pt-24">
                <div aria-hidden="true" class="pointer-events-none absolute inset-x-0 -top-24 mx-auto h-96 max-w-3xl rounded-full bg-gradient-to-br from-teal-500/25 to-red-500/10 blur-3xl"></div>

                <span class="relative inline-flex items-center gap-1.5 rounded-full border border-teal-200 bg-teal-50 px-3 py-1 text-xs font-medium text-teal-700 dark:border-teal-800 dark:bg-teal-950/60 dark:text-teal-300">
                ...
                <h1 class="relative mx-auto mt-6 max-w-3xl text-balance text-4xl font-bold tracking-tight text-zinc-900 sm:text-6xl dark:text-white">
                    ...
                    <span class="bg-gradient-to-r from-teal-600 to-red-600 bg-clip-text text-transparent">{{ __('actually finish') }}</span>
                </h1>
            ...
            <section class="mx-auto w-full max-w-6xl px-6 pb-24">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ([
                        ...
                        <div class="rounded-2xl border border-zinc-200 bg-white p-6 transition hover:border-teal-300 hover:shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-teal-900">
                            <span class="flex size-10 items-center justify-center rounded-xl bg-teal-50 dark:bg-teal-950/60">
                                <flux:icon :icon="$feature['icon']" class="size-5 text-teal-600 dark:text-teal-400" />
                            </span>
